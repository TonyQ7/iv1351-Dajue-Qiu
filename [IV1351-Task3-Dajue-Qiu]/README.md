...
- **controller**: Thin coordination layer (pass-through to model)
- **integration**: Data access layer (DAO) - CRUD operations only
- **model**: Business logic (TeachingService) and domain entities/DTOs
